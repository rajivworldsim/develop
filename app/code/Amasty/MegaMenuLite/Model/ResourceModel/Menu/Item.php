...
class Item extends AbstractDb
{
    ...
    protected function _afterSave(AbstractModel $object)
    {
        if ($object->getType() === ItemInterface::CATEGORY_TYPE) {
            $this->updateCategorySortOrder($object);
        } else {
    ...
    {
        $data = $this->getPositionDataByStore($object, [$object->getStoreId()]);
    ...
    private function updateCategorySortOrder(ItemInterface $object): void
    {
        $storeIds = [];
    ...
    private function getPositionDataByStore(ItemInterface $object, array $storeIds): array
    {
        ...
        foreach ($storeIds as $storeId) {
            $data[] = [
                ...
                Position::POSITION => $object->getSortOrder(),
