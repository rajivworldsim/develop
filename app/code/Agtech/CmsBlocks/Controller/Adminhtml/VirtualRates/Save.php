...
use \Agtech\CmsBlocks\Model\VirtualRates\VirtualRateFactory;
use Magento\Framework\App\Filesystem\DirectoryList;
class Save extends \Magento\Backend\App\Action
{

    /**
     * @var \Agtech\CmsBlocks\Model\VirtualRates\VirtualRateFactory
     */
     ...
     * @param \Agtech\CmsBlocks\Model\VirtualRates\VirtualRateFactory
     * @param \Magento\Framework\File\Csv $csv
     */

    public function __construct(
        Action\Context $context,
        VirtualRateFactory $VirtualRateFactory,
    ...
    public function execute()
    {
        ...
        $jsonData = $this->VirtualRateFactory->create();
        $jsonHeaders = array();
        ...
        try {
            ...
            if ($this->getRequest()->getParam('back')) {
                if ($this->getRequest()->getParam('back') == 'add') {
                    ...
                    return $resultRedirect->setPath('*/*/edit', ['entity_id' => $this->VirtualRateFactory->getEntityId(), '_current' => true]);
                }
            }
