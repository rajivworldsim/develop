...
use \Agtech\CmsBlocks\Model\GoogleReviews\GoogleReviewFactory;
use Magento\Framework\App\Filesystem\DirectoryList;
class Save extends \Magento\Backend\App\Action
{

    /**
     * @var \Agtech\CmsBlocks\Model\GoogleReviews\GoogleReviewFactory;
     */
     ...
     * @param \Agtech\CmsBlocks\Model\GoogleReviews\GoogleReviewFactory;
     * @param \Magento\Framework\File\Csv $csv
     */

    public function __construct(
        Action\Context $context,
        GoogleReviewFactory $googleReviewFactory,
    ...
    public function execute()
    {
        ...
        $jsonData = $this->googleReviewFactory->create();
        $jsonHeaders = array();
        ...
        try {
            ...
            if ($this->getRequest()->getParam('back')) {
                if ($this->getRequest()->getParam('back') == 'add') {
                    ...
                    return $resultRedirect->setPath('*/*/edit', ['entity_id' => $this->callingToNewFactory->getEntityId(), '_current' => true]);
                }
            }
