...
class WarmRule extends AbstractModel implements WarmRuleInterface
{
    ...
    {
        try {
            $data = SerializeService::decode($this->getData(self::HEADERS_SERIALIZED));
            if (!$data) {
                return [];
            }
        } catch (\Exception $e) {
    ...
    {
        return $this->setData(self::HEADERS_SERIALIZED, SerializeService::encode($value));
    }
    ...
    {
        try {
            $data = SerializeService::decode($this->getData(self::VARY_DATA_SERIALIZED));
            if (!$data) {
                return [];
            }
        } catch (\Exception $e) {
    ...
    {
        return $this->setData(self::VARY_DATA_SERIALIZED, SerializeService::encode($value));
    }
