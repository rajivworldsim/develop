...
class Job extends AbstractModel implements JobInterface
{
    ...
    {
        try {
            $data = SerializeService::decode($this->getData(JobInterface::FILTER_SERIALIZED));
            if (!$data) {
                return [];
            }
        } catch (\Exception $e) {
    ...
    {
        return $this->setData(JobInterface::FILTER_SERIALIZED, SerializeService::encode($value));
    }
    ...
    {
        try {
            $data = SerializeService::decode($this->getData(JobInterface::INFO_SERIALIZED));
            if (!$data) {
                return [];
            }
        } catch (\Exception $e) {
    ...
    {
        return $this->setData(JobInterface::INFO_SERIALIZED, SerializeService::encode($value));
    }
    ...
    {
        try {
            $data = SerializeService::decode($this->getData(JobInterface::TRACE_SERIALIZED));
            if (!$data) {
                return [];
            }
        } catch (\Exception $e) {
    ...
    {
        return $this->setData(JobInterface::TRACE_SERIALIZED, SerializeService::encode($value));
    }
