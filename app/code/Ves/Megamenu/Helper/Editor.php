                        ...
                        "jquery"
                            ...
                            jQuery(document).ready(function($){
                                jQuery(document).on("click","#'.$buttonBlock->getId().'", function () {
                                    VesMediabrowserUtility.openDialog("' . $this->_backendData->getUrl('cms/wysiwyg_images/index',$fileBrowserUrlParams) . '", null, null,"' . $uploadImageText . '", "")
                                });
                            })
                        })
                    </script>
